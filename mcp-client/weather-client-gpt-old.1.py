...
class MCPClient:
    ...
    async def process_query(self, query: str) -> str:
        ...
        if msg.get("function_call"):
            ...
            # extract the raw text before inserting into our JSON-able chat history
            raw = tool_resp.content.text  # ← pull out the string :contentReference[oaicite:0]{index=0}
